...
# --- Bắt đầu triển khai MyIu Fortress (Phiên bản Gọn nhẹ & Hiệu quả) ---
echo "--- Bắt đầu triển khai MyIu Fortress (Phiên bản Gọn nhẹ & Hiệu quả) ---"
...
echo -e "\n--- 3. Cập nhật các file Frontend (index.html, styles.css, fortress.js) ---"
    ...
    <main>
        ...
        <section class="panel">
            ...
            <div id="log-filter-buttons" style="display: flex; gap: 0.5rem; margin-bottom: 0.5rem; flex-wrap: wrap;">
                ...
                <button class="log-filter-btn" data-filter="alert" style="color: #F87171; font-weight: bold; background-color: rgba(139, 148, 158, .1); border: 1px solid rgba(139, 148, 158, .2); padding: 0.25rem 0.75rem; border-radius: 6px; cursor: pointer;">Cảnh báo</button>
